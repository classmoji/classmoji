...
> How do I update assignment files after the repos have already been created?
...
2. For each student repo, we create a new branch (e.g., `update-assignment-1`).
3. We **pull in changes from the updated template repo** into that branch.
4. Then, you **open a pull request** from that branch into the student's **main**.
