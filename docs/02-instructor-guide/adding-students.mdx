...
<img
  alt='Sync Roster'
  className='rounded'
  src='/guide/add_students_buttons.jpeg'
/>
...
<img alt='Sync Roster' className='rounded' src='/guide/sync_roster.jpeg' />
...
- Even if student does not get Classmoji email invite, they can still access the platform as long as you've added them.
  :::
