...
Classmoji uses a unified test report format called **CTRF** (Common Test Result Format) to interpret student test results, regardless of what language or framework you're using.
