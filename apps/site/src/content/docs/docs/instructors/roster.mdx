...
<Screenshot src={assistantsImg} alt="The Assistants list showing a TA with a grader-role toggle and status" frame url="app.classmoji.io/admin/cs-101/assistants" size="lg" />
