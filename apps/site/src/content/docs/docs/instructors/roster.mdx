...
Paste your student list into the textarea, one per line:
...
When a student accesses the classroom for the first time, they'll receive a Github organization invite. They need to accept it to access their classroom dashboard and get repo access.
