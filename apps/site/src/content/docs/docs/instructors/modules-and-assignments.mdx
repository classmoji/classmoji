...
<Screenshot src={repositoriesImg} alt="The Repositories list showing a repository expanded to its weighted assignments and publish status" frame url="app.classmoji.io/admin/cs-101/repos" size="lg" />
