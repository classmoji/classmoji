...
:::note
Setting stuff up sucks 😭, we all know it. But we promise it's worth it 😊. We've tried to make it as painless as possible, but if you get stuck or have feedback, please reach out to us on [GitHub](https://github.com/classmoji/classmoji) by opening an issue or starting a discussion.
:::
