...
### What is Classmoji?
Classmoji is a Git-native platform for CS courses, think Github Classroom but built for how CS is actually practiced. Every student works in their own repo and submits with a push, instructors get automated workflows and real teaching tools, and nobody has to fight a clunky interface to make it happen.
