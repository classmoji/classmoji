...
| Repository | Repository | Each Classmoji repository maps to a Github repo, grouping related assignments together. |
| Issue | Assignment | Each assignment is a Github issue, tied to the repository. |
...
Repositories group related assignments, quizzes, pages, and slides together, similar to a unit or week. You can weight repositories for grading and mark them as extra credit.
