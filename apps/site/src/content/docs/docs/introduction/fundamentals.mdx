...
Where exactly the lines fall — who sees student emails, who can edit a slide deck, who can delete the classroom — is spelled out row by row in [Who can do what](/docs/instructors/permissions).
