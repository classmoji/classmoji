 ...
 *
 * The student calendar is its own component (`StudentCalendarView`, no dnd-kit)
 * and had no coverage at all, so this mirrors tests/owner/calendar/calendar.spec.ts
 * and adds the two things specific to the student view: no authoring
 * affordances, and clicking an event opens a read-only detail modal.
 *
