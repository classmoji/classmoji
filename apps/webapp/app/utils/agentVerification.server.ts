...
let verificationSocket: Socket | null = null;
let connectionPromise: Promise<Socket> | null = null;

/**
 * Get or create a socket connection for verification
 */
function getVerificationConnection(): Promise<Socket> {
  if (verificationSocket && verificationSocket.connected) {
  ...
  connectionPromise = new Promise((resolve, reject) => {
    ...
    verificationSocket.once('connect_error', (error: Error) => {
      clearTimeout(connectTimeout);
      connectionPromise = null;
