 ...
 */
export function getCalendarDateRange(year: number, month: number) {
 ...
 */
export function generateCalendarSignature(slug: string) {
  if (!CALENDAR_SECRET) {
    return null;
  }
 ...
 */
export function buildCalendarUrl(slug: string) {
