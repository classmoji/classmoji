 ...
 */
async function handleInitSession(request: Request, formData: FormData) {
  const classroomSlug = formData.get('classroomSlug') as string;
  const formContextJson = formData.get('formContext') as string | null;
  ...
  try {
    ...
    return jsonResponse({
      ...
      hasCodeExploration: resultPayload.hasCodeExploration || false,
    });
  } catch (error: unknown) {
 ...
 */
async function handleSendMessage(request: Request, formData: FormData) {
  const classroomSlug = formData.get('classroomSlug') as string;
 ...
 */
async function handleEndSession(request: Request, formData: FormData) {
  const classroomSlug = formData.get('classroomSlug') as string;
  const sessionId = formData.get('sessionId') as string | null;
