...
// extractBodyContent: extract inner body from wrapped HTML
...
export const action = async ({ request, params }: Route.ActionArgs) => {
  ...
  if (intent === 'import-content') {
    ...
    try {
      ...
      console.log('[import-content] Markdown file:', (markdownFile as File)?.name);
  ...
  if (intent === 'save') {
    ...
    try {
      ...
      return { error: error instanceof Error ? error.message : 'Failed to save page' };
    }
  }
