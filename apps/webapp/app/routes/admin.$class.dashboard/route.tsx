      ...
      <Suspense fallback={<Skeleton active />}>
        <Await resolve={data}>
          {([
            ...
            return (
              <>
                <div className="rounded-[15px] bg-panel ring-1 ring-stone-200 dark:ring-neutral-800 overflow-hidden flex flex-col sm:flex-row divide-y sm:divide-y-0 sm:divide-x divide-stone-200/70 dark:divide-gray-800">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <section className="rounded-[15px] bg-panel ring-1 ring-stone-200 dark:ring-neutral-800 p-4 sm:p-5">
