...
const StudentList = ({ students, title, isTop = false }: StudentListProps) => (
...
interface LeaderboardProps {
  ...
  bottomStudents: LeaderboardStudent[];
}

const Leaderboard = ({ topStudents, bottomStudents }: LeaderboardProps) => {
  return (
