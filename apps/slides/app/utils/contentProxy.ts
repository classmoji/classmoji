 ...
 */
export function detectMimeFromMagicBytes(content: Buffer): string | null {
 ...
 */
export function getMimeType(path: string, content?: Buffer): string {
 ...
 */
export function getContentProxyUrl(org: string, repo: string, path: string): string {
 ...
 */
export function getThemeProxyUrls(org: string, repo: string, themePath: string) {
  return {
