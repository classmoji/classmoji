  ...
  return (
    <div className="space-y-4">
      <PropertySection title="Code Playground">
        ...
        {config.layout !== 'preview-bottom' &&
          config.layout !== 'preview-only' &&
          config.layout !== 'editor-only' && (
            <div className="space-y-2 mt-3">
              <label className="block text-xs font-medium text-gray-700 dark:text-gray-300">
                Editor Width
              </label>
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={e =>
                    updateAttribute('editorWidth', (e.target as HTMLInputElement).value)
                  }
                  className="flex-1"
                />
      ...
      <PropertySection title="Display Options">
        ...
        <div className="flex items-center justify-between">
          <label className="text-xs text-gray-700 dark:text-gray-300">Show file tabs</label>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between mt-2">
          <label className="text-xs text-gray-700 dark:text-gray-300">Show line numbers</label>
          <input
            type="checkbox"
        ...
        {/* Show console toggle */}
        <div className="flex items-center justify-between mt-2">
          <label className="text-xs text-gray-700 dark:text-gray-300">Show console</label>
          <input
            type="checkbox"
        ...
        {/* Read-only toggle */}
        <div className="flex items-center justify-between mt-2">
          <label className="text-xs text-gray-700 dark:text-gray-300">Read-only mode</label>
          <input
            type="checkbox"
      ...
      <PropertySection title="Visible Files">
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
          Select which files appear as tabs. Unchecked files are still included in the bundle but
          hidden from view.
        </p>
      ...
      <div className="text-xs text-gray-500 dark:text-gray-400 mt-4 p-2 bg-gray-50 dark:bg-gray-700 rounded">
        ...
        <p>
          Code changes are saved automatically. Students can edit and run code during presentations
          - changes won&apos;t affect your saved content.
        </p>
      </div>
    </div>
  );
