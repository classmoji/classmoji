  ...
  return (
    ...
    >
      <div className="text-center" onClick={e => e.stopPropagation()}>
        ...
        <p className="text-white/70 mt-6 text-lg">Scan to join</p>

        <p className="text-white/40 mt-2 text-sm font-mono break-all max-w-md mx-auto">{url}</p>

        <p className="text-white/30 mt-8 text-sm">Press ESC or click outside to close</p>
      </div>
    </div>
  );
}
