...
export interface AssessmentGuidelines {
  scoringScale: Record<string, string>;
  generalRubric: string;
}
...
export const assessmentGuidelines: AssessmentGuidelines = {
  scoringScale: {
...
export const getExamplePrompts = (): ExamplePrompt[] => examplePrompts;
