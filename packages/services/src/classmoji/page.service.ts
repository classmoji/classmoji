 ...
 * Find a page by ID
 */
export async function findById(pageId: string, options: any = {}) {
 ...
 */
export async function findByClassroomId(classroomId: string, options: any = {}) {
 ...
 * Update a page
 */
export async function update(pageId: string, updates: any) {
 ...
 */
export async function findByContentPath(classroomId: string, contentPath: string, options: any = {}) {
 ...
 */
export async function quickUpdate(pageId: string, updates: any) {
  const page = await prisma!.page.update({
    where: { id: pageId },
    data: {
      ...updates,
